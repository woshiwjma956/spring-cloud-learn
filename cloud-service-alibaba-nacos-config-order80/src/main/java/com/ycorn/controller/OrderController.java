...
import com.ycorn.service.AlibabaNacosServiceFeignClient;
...
public class OrderController {
    ...
    @Autowired
    private AlibabaNacosServiceFeignClient alibabaNacosServiceFeignClient;
    ...
    @GetMapping("/${mic-services.order}/payment/nacosConfig")
    public CommonResult consumePaymentNacosConfig(){
        return alibabaNacosServiceFeignClient.nacosConfig();
    }
}